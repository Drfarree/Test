      ...
      <div className="w-full p-4">
        ...
        >
          ...
          <div className="prod-title">
            <p className="text-2xl font-bold text-gray-900 uppercase mt-2">
              {name}
            </p>
          ...
          <div className="grid gap-10 prod-info">
            <div className="flex flex-col items-center justify-between text-gray-900 md:flex-row pt-5">
              <p className="text-xl font-bold">
                <span>Price:</span>{" "}
                <span style={{ color: "#3633ccd9" }}>{price}</span>{" "}
                <span style={{ color: "#3633ccd9" }}>{currency}</span>
              </p>

              {/* <ButtonServiceRedirect textButton="Buy Now" hasArrow={false}/> */}

              <button
                className="inline-block items-center w-full px-6 py-3 mb-3 text-lg border-2 border-gray-200 rounded-full sm:mb-0 hover:bg-[#ffff00]  sm:w-auto text-gray-400 duration-200 hover:bg-opacity-50 hover:border-gray-400 hover:text-gray-500 bg-gray-100"
                onClick={handleBuy}
              >
                Buy Now
              </button>
