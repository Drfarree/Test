...
const Home = () => {
  return (
    <>
      <section
        className="px-2 py-20 bg-white md:px-0"
        style={{ backgroundColor: "#000123" }}
      >
        <div className="container max-w-full px-8 mx-auto xl:px-5">
          <div className="flex flex-wrap sm:-mx-3">
            <div className="md:w-1/2 md:px-20">
              <div className="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-full md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
                <h2 className="text-4xl text-white sm:text-4xl md:text-2xl lg:text-3xl xl:text-4xl">
                  <span className="block xl:inline">MACHINE LEARNING</span>
                </h2>
                <h1 className="text-4xl font-extrabold text-white sm:text-6xl md:text-5xl lg:text-6xl xl:text-7xl w-5">
                  <span className="block text-white ">FEDERATED LEARNING</span>
                </h1>
                <p className="text-base text-justify text-gray-500 sm:max-w-md lg:text-2xl md:max-w-3xl">
            ...
            <div className="w-full md:w-1/2">
              <div className="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                <img src={IAhand} className="relative float-right" />
              </div>
            </div>
          </div>
        </div>
